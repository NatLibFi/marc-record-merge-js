...
function factory(Object, shim_array, jjv, jjve, MarcRecord, schema_configuration, schema_action_copy, schema_action_select_better)
{
	...
	function actionSelectBetter(record_merged, field_other, options, return_details) {
	    ...
	    var error_invalid_record, field_merged, field_merged_normalized, field_other_normalized, field_other_copy, subfield_pairs_sizes, subfield_pairs_scores, fn_comparator,
	    details = return_details ? {} : undefined,
		...
		if (arrayDifference(field_merged_normalized.subfields, field_other_normalized.subfields, fn_comparator).length === 0 && arrayDifference(field_merged_normalized.subfields, field_other_normalized.subfields, fn_comparator).length === 0) {
