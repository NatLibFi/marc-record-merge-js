...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define([
      ...
      'marc-record-js',
      '@natlibfi/melinda-marc-record-utils/dist/punctuation'
    ], factory);
    ...
    module.exports = factory(
      ...
      require('@natlibfi/melinda-marc-record-utils/dist/punctuation')
    );
  } else {
...
function factory(Object, shim_array, MarcRecord, MarcRecordPunctuation)
{
  ...
  return function(configuration, options)
  {
