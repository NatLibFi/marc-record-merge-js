...
(function (root, factory) {
	...
	root.mergeMarcRecordsFactory = factory(root.Object, root.es6_array_shim, root.jjv, root.jjve, root.MarcRecord, root.mergeMarcRecordsSchema);
    }

}(this, factory));

function factory(Object, shim_array, jjv, jjve, MarcRecord, schema)
{
	...
	function validateConfiguration()
	{
	    ...
	    if (errors) {
		throw new Error('Invalid configuration: ' + JSON.stringify(je(schema, configuration, errors), undefined, 4));
	    }
	...
	function actionCopy(record_merged, field_other, options, return_details) {
	    ...
	    var subfields_compare_without, removed_subfields_preferred, removed_subfields_other, field_preferred, field_preferred_normalized, field_other_normalized, field_other_copy,
	    details = return_details ? {} : undefined;

	    options = typeof options === 'object' ? options : {};

	    field_preferred = shim_array.find(record_merged.fields, function(field) {
